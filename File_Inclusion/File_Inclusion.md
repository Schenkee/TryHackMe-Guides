...
But first lets to a quick manual test to verify the RFI vulnerability. Open up your terminal and input ```echo "Hello World" > test.php``` This will create a .PHP file with "Hello World"
